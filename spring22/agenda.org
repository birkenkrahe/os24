...
** Topics
   ...
   * [X] See practice file ~compiling.org~ [[https://drive.google.com/drive/folders/1Dp9z3e4HOoB-LAs6IthcDIOqXUfhhE4T?usp=sharing][in GDrive]]

   * [X] Works well with Cygwin (except the last step?)
   
   * [X] What is compiling?

   * [X] Source code compilation pipeline
