...
** TODO Practice: Shell fundamentals (Shott ch1)

- Terminal emulator vs. terminal (Emacs eshell)
- Explore the shell in the terminal
- Open Emacs
- Open Emacs shell (~M-x eshell RET~)
- Open Linux shell (~M-x shell RET~)
