...
* DONE Week 12 - Changing identities and first bash script
#+attr_html: :width 400px:
[[../img/week_12.png]]
...
** DONE Test 5 ("file permissions") is available until Sunday 21 April
...
** DONE Bash programming exercise ([[https://lyon.instructure.com/courses/2255/assignments/26725][Canvas]])
...
** DONE 2nd sprint review (update in class)
#+attr_html: :width 300px:
...
** DONE Finish shared drive creation and changing passwords
...
** TODO Review: Bash scripting - variables
...
3) What does "shell within a shell" mean?
   ...
   #+RESULTS:
   : The date is Thu Apr 18 08:48:18 AM CDT 2024
   : The date is Thu Apr 18 08:48:18 AM CDT 2024
   : 9
   : 
...
** TODO Introduction to process management

Codealong file: tinyurl.com/process-codealong


* Week 14 - Networking & Environment variables
#+attr_html: :width 500px:
[[../img/week_14.png]]

- Codealong file: tinyurl.com/networking-codealong
- Codealong file: tinyurl.com/environment-codealong


* Week 15 - Compiling from source (=make=) - Thu: final presentations

Codealong file: tinyurl.com/compiling-codealong
