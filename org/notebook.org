...
- [ ] *Practice*: Manipulating files (~mkdir~, ~mv~, ~rm~, ~ln~) -
...
** TODO Practice: Update/upgrade PiOS / Emacs shells / LitProg
...
** TODO DataCamp lesson review: manipulating files (practice)
...
** TODO Project challange - conceptual projects
