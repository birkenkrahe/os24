...
** TODO Feedback: project proposal
** TODO Finish "manipulating files" (symbolic links/removing directories)
...
- Complete the Canvas home assignment in tinyurl/files-practice-org.

- Save the file using M-x eww to files_practice.org and complete it.

- Upload your completed Org-mode file to Canvas by 11am on Thu 22 Feb
