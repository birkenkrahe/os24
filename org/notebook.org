g#+TITLE: Notebook - Operating Systems
...
** Finish "manipulating files" (symbolic links/removing directories)
** Working with shell commands & the file system (code along)
...
** Pop quiz 1 - manipulating files and data - 60 min
...
- Get together in pairs and explain your project and your progress to
  your partner (10 min)

- Your partner will then introduce your project to everyone else (35 min):
  1) Your motivation
  2) Your final deliverable
  3) Your main challenges
  4) Your next steps

** Working with shell commands - 60-75 min
