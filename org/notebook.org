...
** DONE Lecture: OS fundamentals (Feb 6)
...
** DONE 10 review questions OS videos
...
** DONE OS fundamentals demo - four easy pieces
...
** DONE DataCamp `shell` review - Where are we? What do you know?
...
** TODO Working with shell commands & the file system (code along)

Add ~<b~ as ~src bash~ to ~org-structure-template-alist~
...
** TODO Due next week: your project proposal ([[https://lyon.instructure.com/courses/2255/assignments/24827][Canvas]]/[[https://drive.google.com/drive/folders/1glJ_hZ_NybaQIvkPHysiG-FeZ1wSyz6n?usp=drive_link][GDrive]])
