...
* Week 11 - Permissions / Raspberry Pi hardware and GPIO pins
#+attr_html: :width 400px:
[[../img/he_is_risen.png]]

/Image: Surprise moment in the coding room, Easter 1964./

- [ ] *Bonus assignment*: test your understanding ([[https://lyon.instructure.com/courses/2255/assignments/26487][Canvas]]) by May 7
- [ ] *Test 4* (working with shell and redirection) 30 pts, Sun Apr 7
- [ ] *Permissions* - download the update: [[http://tinyurl.com/permissions-org][tinyurl.com/permissions-org]]
- [ ] *Raspberry Pi* and GPIO pins (lab) - post-permissions, pre-process

* Week 12 - PROCESS & 2nd SPRINT REVIEW
* Week 13 - NETWORKING
* Week 14 - BASH SCRIPTS
