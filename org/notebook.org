...
** TODO 10 review questions OS videos
...
** TODO OS fundamentals demo - four easy pieces
...
** TODO DataCamp `shell` review - Where are we? What do you know?
...
- open or reopen [[http://tinyurl.com/2-manipulate-practice-org][tinyurl.com/2-manipulate-practice-org]]
- run through the code blocks
- let's finish it with linking and removal commands

** TODO Working with shell commands (practice)
