...
7) [[https://chat.google.com/room/AAAABlWSGes/XLBWCv-g92k/XLBWCv-g92k?cls=10][Build an interactive terminal-based portfolio website]]
8) Improve your bash skills (e.g. with "[[https://chat.google.com/room/AAAABlWSGes/kJI69Cd8DCI/kJI69Cd8DCI?cls=10][Wicked Cool Shell Scripts]]")
9) [[https://chat.google.com/room/AAAABlWSGes/k1SXXubOHrw/k1SXXubOHrw?cls=10][Classic: "The structure and interpretation of computer programs"]]
10) Dump Windoze. Don't think about it, just do it.

My own path: I'll focus on C + Python + SQL as the winning combo.

Next term: the ol' switcheroo
1) [COR 100] Game programming with Python[fn:1]
2) [DSC 105] Re-imagined introduction to data science in Python[fn:2].
3) [CSC 240] My first time teaching data structures with C++[fn:3] 
4) [DSC 302] Data visualization with various free tools[fn:4]

* Post-mortem (May 23)

Thanks everyone for the nice evaluations! Since I won a research grant
from Lyon, with some luck and (IT) sweat, we'll have a proper
Linux-based computer and data science lab set up by fall, and coding
along will work a little better. The Raspberry Pi's contributed to the
winning combo, as did DataCamp - though the "bash scripting" component
of the course probably fell off the edge for some of you, I am
afraid - I apologize. If you're fortunate (and look for it), you'll
find ample opportunity to use your command line skills - the more AI
infuses our interfaces with the machine, the more powerful this
knowledge becomes: this is not a paradox - it is a necessary
consequence of automation - the most precious processes are not
automated, and those who master them, are the keepers of the keys to
the kingdom. You're also still owed some "DLC" -two 'lost lectures' -
one on the Pi and one on Linux networking. I am planning to complete
these for your benefit some time soon. But I also have a book to
write! Image: Summer by Caspar David Friedrich (1807).

#+attr_html: :width 400px:
[[../img/caspar_david_friedrich_summer_1807.png]]
...
[fn:1]I'm switching from Snap! to Python for game programming with
some of Lyon's newest arrivals. Snap! (like Scratch) was block-based,
and it's fairly easy fun, but Python isn't exactly hard (at the start)
and I'm itching to get better myself at programming games with it.

[fn:2]I've finally decided to take the plunge though it'll hurt, too:
to move fully from R to Python. The reason is the progressing
contamination of R by the "Tidyverse", and the restriction of R to
academia. Otherwise, both languages are (still) very comparable for
(most areas of) data science, with R leading in visualization. Those
of you who had the fortune to learn R - maintain your skill level!

[fn:3]I hope to learn a lot! And if I learn a lot, the students have a
better chance to learn more, too, because I'll be fully engaged with
all senses and all fingers on the keyboard at all times! I'll be
[[https://www.manning.com/books/grokking-data-structures][grokking data structures]] all summer long.

[fn:4]Interactive visualization with a variety of free tools and with
Python. This course also used to be in R only and I hope to have the
time over the summer to switch it to Python.
