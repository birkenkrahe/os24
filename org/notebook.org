...
- [ ] Lecture: OS fundamentals (Tuesday)
- [ ] Practice: Get started with Raspberry Pi: connect and update (Tuesday)
- [ ] DataCamp review/Practice: Manipulating files and directories (Tuesday)
...
** TODO Practice: Shell fundamentals
...
** TODO Lecture: OS fundamentals

- [[file:1_fundamentals.org]]
